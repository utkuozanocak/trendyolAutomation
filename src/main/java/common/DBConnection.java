...
public class DBConnection extends BaseLibrary {
    ...
    public Connection connectPrp() throws SQLException,ClassNotFoundException
    {
        Connection connection;
        String[] _dataSet = new String[2];
...
//        return dataSet;
//    }
    public Connection connectFoxPrp() throws SQLException,ClassNotFoundException
    {
        Connection connection;
        Statement statement;
        ResultSet rs;
