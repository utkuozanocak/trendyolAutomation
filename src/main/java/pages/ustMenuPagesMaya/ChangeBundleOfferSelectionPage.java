...
public class ChangeBundleOfferSelectionPage extends MainPageMaya {
    ...
    SolCrmElement CMB_YENI_KAMPANYA = comboBox(GetObject("MAYA","CMB_YENI_KAMPANYA","CSS_SELECTOR","ChangeBundleOfferSelectionPage","PRP"));
    ...
    public ChangeBundleOfferSelectionPage cmbYeniKampanya(String gecisKampanya) {
        CMB_YENI_KAMPANYA.selectComboBox(gecisKampanya);
        return this;
    }
